export class SpeedHeroesBaseDice extends foundry.dice.terms.Die {
	...
	getResultLabel(result) {
		return {
			...
			5: '<img src="systems/speedheroes/ui/dice/SpeedHeroes_0-1.png" />',
			6: '<img src="systems/speedheroes/ui/dice/SpeedHeroes_1-1.png" />',
			7: '<img src="systems/speedheroes/ui/dice/SpeedHeroes_2-2.png" />',
			8: '<img src="systems/speedheroes/ui/dice/SpeedHeroes_2-3.png" />',
			9: '<img src="systems/speedheroes/ui/dice/SpeedHeroes_0-2.png" />',
